...
def delet_place(place_id):
    """does removing of place by identifier"""
    place = storage.get(Place, place_id)
    if place is None:
        abort(404)
    place.delete()
...
def search_places_by_id():
    """does place search by identifier"""
