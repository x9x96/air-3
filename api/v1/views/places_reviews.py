...
def delet_review(review_id):
    """removes review by identifier"""
    review = storage.get(Review, review_id)
    if review is None:
        abort(404)
    review.delete()
